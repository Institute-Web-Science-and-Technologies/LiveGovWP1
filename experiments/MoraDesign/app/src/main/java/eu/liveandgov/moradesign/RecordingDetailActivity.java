 ...
 * more than a {@link RecordingDetailFragment}.
 */
public class RecordingDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(RecordingDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(RecordingDetailFragment.ARG_ITEM_ID));
