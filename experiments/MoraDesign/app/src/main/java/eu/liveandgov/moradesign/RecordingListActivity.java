package eu.liveandgov.moradesign;
 ...
 * {@link RecordingListFragment} and the item details
 * (if present) is a {@link RecordingDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link RecordingListFragment.Callbacks} interface
...
public class RecordingListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.recording_detail_container) != null) {
            ...
            ((RecordingListFragment) getFragmentManager()
    ...
    /**
     * Callback method from {@link RecordingListFragment.Callbacks}
