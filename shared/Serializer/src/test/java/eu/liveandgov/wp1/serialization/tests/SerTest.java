...
import eu.liveandgov.wp1.serialization.impl.ItemSwitch;
...
public class SerTest {
    public static void main(String[] args) {
        ...
        final Item prx = ItemSwitch.ITEM_SWITCH.deSerialize("PRX,1391515681876,mrazr,platform/true/Anschützstraße");
