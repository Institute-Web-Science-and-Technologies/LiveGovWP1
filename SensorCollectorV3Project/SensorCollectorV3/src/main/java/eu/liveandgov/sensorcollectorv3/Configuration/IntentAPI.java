...
public class IntentAPI {
     ...
     * Status updates are returned via the STATUS_RETURN intent, and contain the following
     * boolean fields:
    ...
    public static final String STATUS_RETURN = "eu.liveandgov.sensorcollectorapi.intent.return.STATUS";
     ...
     *
     * The {@code LOG_RETURN} intent contains a "message" field.
     */
    ...
    public static final String LOG_RETURN = "eu.liveandgov.sensorcollectorapi.intent.return.LOG";
