...
app.directive('map', function() {
	return {
		...
		link: function(scope, element, attrs) {
			...
			var API_KEY = 'bc9a493b41014caabb98f0471d759707'; // uni api key
			var URL = 'http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png' // OSM

			// var API_KEY = 'a04e905a7d8448d8b412b7371dfa21be'; // my api key
			// var URL = 'http://{s}.tile.cloudmade.com/' + API_KEY + '/998/256/{z}/{x}/{y}.png' // CLOUDMADE
