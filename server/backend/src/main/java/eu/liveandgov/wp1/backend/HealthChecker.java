...
//	private static final String SERVICE_CENTER_URL = "http://localhost:8080/";
	...
	private String lastCommitTimestamp = "1970-01-01T00:00Z";
	...
	class SetHealthCheckThread extends Thread {
	    ...
	    public void run() {
	        for (;;) {
	            try {
	            	System.out.println(c.setHealthCheck("10", c.checkSLD()));
	...
	public static void main(String [] args)
	{
		...
		try {
			System.out.println(c.setHealthCheck("10", c.checkSLD()));
//			System.out.println(c.postLogFile("13", "ServiceLineDetection.log"));
			System.out.println(c.checkSLD());
